      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <a href="" class="flex ml-2 md:mr-24">
            <!-- <img :src="`${vite_url}images/logo.svg`" class="h-8 mr-3" alt="FlowBite Logo" /> -->
            <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Artist</span>
          </a>
        ...
        <div class="flex items-center">
          ...
          <!-- Dropdown menu -->
          <div
            class="z-20 z-50 hidden max-w-sm my-4 overflow-hidden  list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:divide-gray-600 dark:bg-gray-700"
            ...
            <div>
              <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                <div class="flex-shrink-0">
                  <img class="rounded-full w-11 h-11" :src="`${vite_url}images/users/bonnie-green.png`" alt="Jese image">
                  <div
              ...
              <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                <div class="flex-shrink-0">
                  <img class="rounded-full w-11 h-11" :src="`${vite_url}images/users/jese-leos.png`" alt="Jese image">
                  <div
              ...
              <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                <div class="flex-shrink-0">
                  <img class="rounded-full w-11 h-11" :src="`${vite_url}images/users/joseph-mcfall.png`"
                    alt="Joseph image">
                  <div
              ...
              <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                <div class="flex-shrink-0">
                  <img class="rounded-full w-11 h-11" :src="`${vite_url}images/users/leslie-livingston.png`"
                    alt="Leslie image">
                  <div
              ...
              <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-600">
                <div class="flex-shrink-0">
                  <img class="rounded-full w-11 h-11" :src="`${vite_url}images/users/robert-brown.png`"
                    alt="Robert image">
                  <div
            ...
            <a href="#"
              class="block py-2  font-normal text-center text-gray-900 bg-gray-50 hover:bg-gray-100 dark:bg-gray-700 dark:text-white dark:hover:underline">
          ...
          <!-- Dropdown menu -->
          <div
            class="z-20 z-50 hidden max-w-sm my-4 overflow-hidden  list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600"
            id="apps-dropdown">
            <div
              class="block px-4 py-2  font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
              Apps
          ...
          <div class="flex items-center ml-3">
            ...
            <!-- Dropdown menu -->
            <div
              class="z-50 hidden my-4  list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
              id="dropdown-2">
